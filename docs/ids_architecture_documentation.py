"""
IDS System Architecture Documentation

Complete system architecture with integration points and data flows
"""
...
if __name__ == "__main__":
    ...
    with open("ids_system_architecture.txt", "w", encoding="utf-8") as f:
        f.write(SYSTEM_ARCHITECTURE)
    
    print("\nArchitecture documentation saved to: ids_system_architecture.txt")
